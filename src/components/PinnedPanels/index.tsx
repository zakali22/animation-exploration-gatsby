...
const PinnedPanels = () => {
    ...
    useGSAP(() => {
        ...
        if(panelsContentRef.current && panelsImagesRef.current){
            Array.from(panelsContentRef.current.children).forEach(slide => {
                gsap.set(slide, {autoAlpha: 0.4})
            })
    
            Array.from(panelsImagesRef.current.children).forEach(slide => {
            ...
            console.log(panelsContentRef.current.children[0])

            tl.addLabel('showPanel1')
            tl.to(panelsContentRef.current.children[0], {autoAlpha: 1, duration: 2, scrollTrigger: {
                trigger: panelsContentRef.current,
                start: "top center",
                end: "+=140",
                // toggleActions: "play none none none", 
                onEnter: function() {
                    console.log("enter pinned section");
                },
                // pin: panelsContentRef.current,
                scrub: 2, 
                // markers: true, 
    ...
    return (
        <section className="panels" data-current-slide="0" ref={containerRef}>
            ...
            <div className="panels-images panel" ref={panelsImagesRef}>
