...
type RevealHeaderImgProps = {
    hoverImg: string | null
}

export default function RevealHeaderImg({ hoverImg }: RevealHeaderImgProps){
    ...
    useGSAP(() => {
        ...
        if(svgPath){
            ...
            tl2
                .set(svg, { attr: { d: "M49,-39.5C64.5,-19.6,78.8,0.8,75.8,18.6C72.7,36.3,52.4,51.4,30.8,60.5C9.1,69.6,-13.7,72.8,-30.8,64.4C-48,56,-59.4,36.1,-63.1,15.6C-66.7,-4.8,-62.7,-25.8,-50.9,-44.8C-39.1,-63.9,-19.5,-81.1,-1.4,-80C16.7,-78.8,33.5,-59.4,49,-39.5Z" } })
        ...
        <div className="reveal-video" ref={containerRef}>
            <svg  viewBox="0 0 550 550">
                ...
                <g clipPath="url(#clipShapeVideo)">
                    <image xlinkHref={hoverImg ? null : heroImage}></image>
                </g>
            </svg>
        </div>
    )
